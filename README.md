...
| `primary_surplus_bea.csv` | — | **Not used.** Formerly the primary-balance control in `02_estimate_term_premium.py`; it ran ~4pp of GDP below the federal primary balance, so script 02 now builds the NIPA federal primary balance from FRED (`FGRECPT`, `B094RC1Q027SBEA`, `FGEXPND`, `A091RC1Q027SBEA`). |
