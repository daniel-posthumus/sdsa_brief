...
\label{fig:debt_path}
	\begin{subfigure}[b]{0.8\textwidth}
		\includegraphics[width=\textwidth]{graphics/sdsa_enrichment_1/sdsa_enrichment1_b_overlay.pdf}
	\end{subfigure}
\end{figure}

As discussed above, debt levels alone are not sufficient for determining debt sustainability (or unsustainability); the dynamics of debt accumulation --- how quickly debt rises and the sources of this rise --- matter for fiscal vulnerability as well. From the law of motion expressed in Equation \ref{eq:sdsa_debt}, we isolate one term, $\frac{r^{av}_t - g_t}{1 + g_t} b_{t-1}$, which captures the interest-growth contribution to debt dynamics. Figure \ref{fig:debt_snowball_term} plots the projected values for $(r^{av}-g)$ for the three different fiscal regimes. For context, we also plot the historical values of this term since 2000. Though there have been recent large increases in debt, Figure \ref{fig:debt_snowball_term} illustrates how primary deficits were driving this accumulation; interest and growth were actually \textit{dampening} public debt accumulation (this speaks directly to the $r-g$ dynamic discussed in our \href{https://siepr.stanford.edu/publications/policy-brief/us-budget-math-looking-dangerous}{previous piece}). $r$ and $g$ are not entirely independent of policy, but are subject to longer-running and more structural forces than the primary deficit; what Figure \ref{fig:debt_snowball_term} illustrates is that even if Congress were to become \textit{ahistorically} concerned about the primary deficit's contribution to debt, longer-running forces on $r$ and $g$ will exert upwards pressure on debt in a way we haven't observed since the Great Financial Crisis.
...
\label{fig:debt_snowball_term}
    \begin{subfigure}[b]{0.8\textwidth}
		\includegraphics[width=\textwidth]{graphics/sdsa_enrichment_1/sdsa_enrichment1_rg_overlay.pdf}
	\end{subfigure}
    \begin{minipage}{0.95\textwidth}
    \footnotesize
    \vspace{0.5em}
    \textit{Note:} The faint line plots the raw annual values for ($r^{av} - g$) for 2000-2025. Then, the bold line is the trend component of a Hodrick-Prescott filter ($\lambda = 100$) applied to the raw series.
    \end{minipage}
\end{figure}
\FloatBarrier

Thus, we conclude that even were Congress to immediately re-discover the fiscal restraint of the 1984-2003 period, debt and the interest-growth contribution to debt accumulation would each continue to rise. 

To operationalize our AA concept, Figure \ref{fig:aa_by_c_regime} plots the historical primary balance (1984-2025) along with the model-implied median primary balance $s_t$ and the corresponding debt-stabilizing primary balance $s^{\text{stab}}_t$ under each $c$ regime. Then, the gap $AA_t = s^{\text{stab}}_t - s_t$ (shown in the pop-outs) is the model-implied primary-balance tightening required to stabilize the debt ratio given the realized (1) interest-growth environment and (2) level of debt held by the public. Even under our upper bound fiscal responsibility assumption, the model implies a median required primary balance tightening of 1.7 percentage points of GDP at the 11-year horizon (2036). For context, consolidations of this magnitude --- even when phased in over several years --- have not occurred in modern history (post-1984) outside of the dot com bubble and post-GFC fiscal consolidation. Under these circumstances, stabilizing the debt --- even in the median projection, barring negative economic shocks --- would likely require an ahistorical fiscal adjustment. Should it become necessary to quickly make an adjustment of these magnitudes, say due to a debt shock, sudden creditor strike, or sharp term-premium spike, the spending cuts and tax hikes would be highly economically disruptive.
...
\label{fig:aa_by_c_regime}
    \begin{subfigure}[b]{0.95\textwidth}
        \includegraphics[width=\textwidth]{graphics/sdsa_enrichment_1/sdsa_primary_balance_story_popouts_c_regimes.pdf}
    \end{subfigure}
    \begin{minipage}{0.95\textwidth}
    \footnotesize
    \vspace{0.5em}
    \textit{Note:} The dashed lines represent the primary balance required to stabilize the debt (per Equation \ref{eq:stab_balance}). The solid lines illustrate the projected actual primary balance. The difference between the dashed and solid lines in 2036 is annotated and referred to as the required Ahistorical Adjustment (AA). 
    \end{minipage}
\end{figure}
...
Some economists have suggested that AI technology, once fully integrated into the workforce and production, will lead to a sharp increase in productivity growth, and that this will raise $g$ relative to $r$, thereby staving off the unsustainable scenarios shown above. For example, Torsten Sløk, chief economist of Apollo, released \href{https://www.apolloacademy.com/ai-could-solve-the-us-fiscal-problem/}{an edition} of his ``Daily Spark'' newsletter in July 2025 titled ``AI Could Solve the US Fiscal Problem'', based on CBO projections. For a sense of the breadth of projections of AI's impacts on growth, Tom Cunningham has \href{https://tecunningham.github.io/posts/2025-10-19-forecasts-of-AI-growth.html}{gathered} the most prominent such projections. The Penn Wharton Budget Model (PWBM) \href{https://budgetmodel.wharton.upenn.edu/issues/2025/9/8/projected-impact-of-generative-ai-on-future-productivity-growth}{estimated} (in a preliminary analysis) that, through productivity and accordingly GDP gains, AI could reduce deficits by \$400 billion (1.4\% of 2024 GDP) between 2026 and 2035.\footnote{Specifically, they find that AI will increase productivity and GDP by 1.5\% by 2035, ~3.5\% by 2055, and ~3.7\% by 2075.} The Yale Budget Lab's \href{https://budgetlab.yale.edu/research/what-might-ai-adoption-mean-fiscal-and-economic-outlook}{recent report} modeled the effect of countervailing trends in AI-induced productivity growth acceleration (increasing revenues) and declines in the labor force participation rate (increasing outlays). They found that in all modeled AI scenarios --- \textit{even those with a lower labor force participation rate} --- the debt stabilizes relative to the baseline projection.

An attribute of our model is that we can simulate the first-order effects of AI under this scenario. We use CBO's \href{https://www.cbo.gov/publication/61914}{interactive tool} to obtain projected real GDP growth and the budgetary effects under 0.5pp and --- more optimistically --- annual 1.0pp boosts to productivity growth.\footnote{The tool only models the effects of productivity boosts up to 0.5pp in magnitude; our 1.0pp scenario is derived from scaling the effects in the 0.5pp output by 2$\times$. This linearity is consistent with previous iterations of this tool, which we were able to unlock to allow for the modeling of productivity boosts greater than 0.5pp.} Note that the CBO tool is not designed to model productivity boosts greater than 0.5pp; because we back out the corresponding estimates, we take the 1.0pp results as directional rather than precise point estimates. The CBO tool estimates the productivity-induced improvements to real GDP growth ($g$) and revenues, which we then apply to the CBO February 2026 baseline, holding $c=0$ to match the post-2004 baseline of negligible fiscal responsiveness. Then we model three different growth scenarios: (1) CBO's baseline growth projections, (2) an AI-induced 0.5pp boost to productivity, and (3) an AI-induced 1.0pp boost to productivity. Figure \ref{fig:ai_snowball} plots the interest-growth contribution to debt accumulation for these three growth scenarios.\footnote{We note that the Penn Wharton Budget Model forecasts AI boosts to productivity would also lower inflation; this would, in practice, also lower interest rates as the Federal Reserve would be less likely to raise the federal funds rate without elevated inflation to fight. A lower interest rate would make the debt path lower, suggesting that our estimates in the faster-than-baseline TFP growth scenario should be viewed as close to upper bounds for the debt-to-GDP ratio.}
...
\label{fig:ai_snowball}
	\begin{subfigure}[b]{0.8\textwidth}
		\includegraphics[width=\textwidth]{graphics/sdsa_enrichment_1/sdsa_enrichment1_snowball_overlay_ai_booms_0.00.pdf}
	\end{subfigure}
    \begin{minipage}{0.95\textwidth}
    \footnotesize
    \vspace{0.5em}
    \textit{Note:} The faint line plots the raw annual values for the interest-growth contribution to debt for 2000-2025. Then, the bold line is the trend component of a Hodrick-Prescott filter ($\lambda = 100$) applied to the raw series.
    \end{minipage}
\end{figure}
\FloatBarrier

Our model's findings suggest that a 1.0pp boost to productivity will, even in the absence of any improvement to Congressional responsiveness, keep interest-growth contributions to debt accumulation negative, such that interest-growth dynamics are working to offset primary deficits. A 0.5pp boost, on the other hand, would stabilize interest-growth contributions to the debt. Anything short of such an optimistic projection (Cunningham notes that most economists forecast an annual 0.1--0.5pp boost to growth), does not appear to ensure fiscal stabilization. However, the gap in the fiscal outcome of the baseline vs. AI boom scenarios is also true to CBO's growth projections; the gap in our projected fiscal outcomes starts to widen as we approach 2036 (year 11 in the model), which is our operational horizon. The gap widens over time because level effects compound; consequently, the difference between baseline and higher-productivity amplifies over longer horizons. This suggests that were we to extend our model outwards, we would likely see significant improvements to the fiscal situation under AI boom conditions as the horizon lengthens.

Figure \ref{fig:aa_by_ai_regime} applies our AA framework to these three scenarios. With a 1.0pp boost to productivity, the model implies $AA_t < 0$ in the median projection --- i.e., debt stabilization does not require any primary balance tightening. With a 0.5pp boost, the median required primary balance tightening is 1.0 percentage points of GDP. Consolidations of this order are not unprecedented when phased in over several years, having occurred outside of the highly irregular periods of the dot com bubble and post-GFC consolidation. However, our concern in this scenario is concentrated in the upper tail of outcomes, where negative economic shocks could still imply historically large required adjustments --- despite the favorable effects of AI on productivity.
...
\label{fig:aa_by_ai_regime}
    \begin{subfigure}[b]{0.95\textwidth}
        \includegraphics[width=\textwidth]{graphics/sdsa_enrichment_1/sdsa_primary_balance_story_popouts_ai_c_0_00.pdf}
    \end{subfigure}
    \begin{minipage}{0.95\textwidth}
    \footnotesize
    \vspace{0.5em}
...
Below we include the regression results from estimating Equation \ref{eq:r_estimation}, under three sample specifications: 1) entire sample, 2) pre-GFC, and 3) post-GFC:\footnote{In the first period of the simulation, we set: $z_1 = 0$ and $r_1 = a_{r1}$ (CBO's baseline). Then, Equation \ref{eq:sdsa_interest_deviations}'s law of motion governs $z_t$'s path starting in $t = 2$. At $t = 2$, the lagged surprise $\Delta b^s_1 = (b_1 - b_0) - \Delta b^{CBO}_1$ uses the last observed debt ratio $b_0$ (4th quarter of 2025), and $\Delta b^s_0$, $\Delta z_1$, and $e^r_1$ are set to zero.}

\input{graphics/sdsa_enrichment_1/acm_tp_regressions_first_diff}

\subsection{Simulation Parameters}
\label{sec:simulation_parameters}

Table~\ref{tab:simulation_parameters} summarizes the parameters governing the Monte Carlo simulations. I calibrate the standard deviations in the model for $g$, $r$, and $s$ to match their historical year-on-year variation (1984--2024, dropping COVID). $\sigma_x$ is fixed at 0.002. The pass-through parameter $\sigma$ reflects roughly 20\% annual turnover in the maturity profile of outstanding federal debt; it is held fixed across our simulations.

\begin{table}[htbp!]
    \centering
    \caption{Simulation parameters used in the SDSA Monte Carlo.}
    \label{tab:simulation_parameters}
    \begin{tabular}{lcl}
        \toprule
        \textbf{Parameter} & \textbf{Value} & \textbf{Description}                  \\
        \midrule
        $N$                & 20{,}000       & Monte Carlo simulations per scenario  \\
        seed               & 42             & Random seed for reproducibility       \\
        $\sigma_g$         & 0.0113         & SD of transitory growth shock $e^g_t$ \\
        $\sigma_x$         & 0.002          & SD of persistent growth shock $e^x_t$ \\
        $\sigma_r$         & 0.0038         & SD of interest-rate innovation $e^r_t$ \\
        $\sigma_s$         & 0.0114         & SD of primary-balance shock $e^s_t$   \\
        $\sigma$           & 0.80           & Pass-through of $r_t$ into $r^{av}_t$ \\
        \bottomrule
    \end{tabular}
\end{table}
